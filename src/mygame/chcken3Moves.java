 ...
 * @author feras
 */
public class chcken3Moves implements Icommand {
 ...
 static Spritefarmer1 farmer1 = new Spritefarmer1(new Image("fala7 rofya3.png"));
  ...
  @Override
    public void move(){
      if (chicken3.positionX ==50&&boat.positionX == 250 )
          
                    {
                        Secondlevel.boatRiders.add(Secondlevel.chicken3);
                        while (chicken3.positionX!=255 ) {
...
//Mygame.leftSide.remove(Mygame.carrot);
            ...
            else if(chicken3.positionX == 255 ) {
                    Secondlevel.boatRiders.remove(Secondlevel.chicken3);
   ...
   //Mygame.leftSide.add(Mygame.carrot);
            ...
            }else if(chicken3.positionX == 385 && boat.positionX==380 ) {
                Secondlevel.boatRiders.remove(Secondlevel.chicken3);
                           Secondlevel.rightSide.add(Secondlevel.chicken3);
  ...
  // Mygame.rightSide.add(Mygame.carrot);
            ...
            else if(chicken3.positionX == 540 && boat.positionX==380 )
            {   
                Secondlevel.boatRiders.add(Secondlevel.chicken3);
                   Secondlevel.rightSide.remove(Secondlevel.chicken3);
                        while (chicken3.positionX !=385 ) {
                            chicken3.addDeltaX(-1);
                            chicken3.addDeltaY(0);
                            chicken3.update();
