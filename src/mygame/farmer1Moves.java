 ...
 * @author feras
 */
public class farmer1Moves implements Icommand {
 ...
 static Spritefarmer1 farmer1 = new Spritefarmer1(new Image("fala7 rofya3.png"));
   ...
   static Spritechicken3 chicken3=new Spritechicken3(new Image("farkha.png"));
    @Override
    public void move(){
       if(farmer1.positionX == 150 && boat.positionX == 250){
           Secondlevel.boatRiders.add(Secondlevel.farmer1);
           while(farmer1.positionX != 245){
               farmer1.addDeltaX(1);
               farmer1.update();
           }
       }
       else if(farmer1.positionX == 245 && boat.positionX == 250){
           Secondlevel.boatRiders.remove(Secondlevel.farmer1);
           while(farmer1.positionX != 150){
               farmer1.addDeltaX(-1);
               farmer1.update();
           }
       }
       else if(farmer1.positionX == 375 && boat.positionX == 380){
           Secondlevel.boatRiders.remove(Secondlevel.farmer1);
           Secondlevel.rightSide.add(Secondlevel.farmer1);
       ...
       else if(farmer1.positionX == 430 && boat.positionX == 380){
           Secondlevel.boatRiders.add(Secondlevel.farmer1);
                                         Secondlevel.rightSide.remove(Secondlevel.farmer1);

           while(farmer1.positionX != 375){
               farmer1.addDeltaX(-1);
               farmer1.update();
           }
       }
